...
#calibtype = 'compression' #used during lab testing
...
tk.ttk.Label(mainframe, text="Secondary Baffles", style="T1.TLabel", font=mirrorfont, foreground=mirrortxtcolor).grid(column=5, row=3)
...
tk.ttk.Label(mainframe, text="Upper Cables", style="T1.TLabel", font=cablefont, foreground=cabletxtcolor).grid(column=4, row=4)
tk.ttk.Label(mainframe, text="Lower Cables", style="T1.TLabel", font=cablefont, foreground=cabletxtcolor).grid(column=5, row=4)
...
tk.ttk.Label(mainframe, text="N", style="T1.TLabel", font=cardinalfont, foreground=cardinaltxtcolor).grid(column=1, row=6)
tk.ttk.Label(mainframe, text="S", style="T1.TLabel", font=cardinalfont, foreground=cardinaltxtcolor).grid(column=1, row=7)
tk.ttk.Label(mainframe, text="E", style="T1.TLabel", font=cardinalfont, foreground=cardinaltxtcolor).grid(column=1, row=8)
tk.ttk.Label(mainframe, text="W", style="T1.TLabel", font=cardinalfont, foreground=cardinaltxtcolor).grid(column=1, row=9)
...
Scdry_Baff_Upper_North_Entry.grid(column=4, row=6, sticky=(tk.W, tk.E))
Scdry_Baff_Upper_South_Entry.grid(column=4, row=7, sticky=(tk.W, tk.E))
Scdry_Baff_Upper_East_Entry.grid( column=4, row=8, sticky=(tk.W, tk.E))
Scdry_Baff_Upper_West_Entry.grid( column=4, row=9, sticky=(tk.W, tk.E))
Scdry_Baff_Lower_North_Entry.grid(column=5, row=6, sticky=(tk.W, tk.E))
Scdry_Baff_Lower_South_Entry.grid(column=5, row=7, sticky=(tk.W, tk.E))
Scdry_Baff_Lower_East_Entry.grid( column=5, row=8, sticky=(tk.W, tk.E))
Scdry_Baff_Lower_West_Entry.grid( column=5, row=9, sticky=(tk.W, tk.E))
