...
calibtype = 'tension' # should be tension when installed at telescope! 
#calibtype = 'compression'
calibration_data = open('load_sensor_calibration_coeffs_{}.txt'.format(calibtype)).readlines()[1:9]
...
tk.ttk.Label(mainframe, text="NE", style="T1.TLabel", font=cardinalfont, foreground=cardinaltxtcolor).grid(column=1, row=4)
tk.ttk.Label(mainframe, text="SW", style="T1.TLabel", font=cardinalfont, foreground=cardinaltxtcolor).grid(column=1, row=5)
tk.ttk.Label(mainframe, text="SE", style="T1.TLabel", font=cardinalfont, foreground=cardinaltxtcolor).grid(column=1, row=6)
tk.ttk.Label(mainframe, text="NW", style="T1.TLabel", font=cardinalfont, foreground=cardinaltxtcolor).grid(column=1, row=7)
